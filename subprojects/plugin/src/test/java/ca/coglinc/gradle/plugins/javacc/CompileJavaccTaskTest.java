...
public class CompileJavaccTaskTest {
    ...
    public void compileJavaccToJavaCompilesEachJavaccInputFileToJava() {
        ...
        assertEquals(GENERATED_FILES.length, subOutputDirectory.list().length);
        assertTrue(Arrays.asList(subOutputDirectory.list()).containsAll(Arrays.asList(GENERATED_FILES)));
    }
    ...
    public void compileJavaccToJavaCompilesEachJavaccInputFileToJavaMultipleSources() {
        ...
        assertEquals(GENERATED_FILES.length + 1, outputDirectory.list().length);
        assertTrue(Arrays.asList(outputDirectory.list()).containsAll(Arrays.asList(GENERATED_FILES)));
    ...
    public void javaccArgumentsAreOutputDirectoryAndFileToCompileWhenNoJavaccArgumentsProvided() {
        ...
        RelativePath inputRelativePath = mock(RelativePath.class);
        when(inputRelativePath.getPathString()).thenReturn("Grammar.jj");
        when(inputRelativePath.getFile(inputDirectory)).thenReturn(new File(inputDirectory, "Grammar.jj"));
        when(inputRelativePath.getFile(outputDirectory)).thenReturn(new File(outputDirectory, "Grammar.jj"));
