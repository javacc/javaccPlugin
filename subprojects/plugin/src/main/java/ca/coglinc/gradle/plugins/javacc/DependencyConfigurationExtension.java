...
public class DependencyConfigurationExtension {
	 ...
	 * This closure need to return a {@literal TaskCollection<JavaCompile>}. Theses tasks will depend on the jjtree task and will include files generated by the jjtree task.
